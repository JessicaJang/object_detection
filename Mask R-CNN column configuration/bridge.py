...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_bridge_0010.h5")
...
class BridgeConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + face
...
class BridgeDataset(utils.Dataset):
    ...
    def load_bridge(self, dataset_dir, subset):
        ...
        self.add_class("bridge", 1, "cylinder")
        self.add_class("bridge", 2, "rectangular")
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "trainval.json")))
        ...
        for a in annotations:
            ...
            if type(a['regions']) is dict:
                ...
                labels = [r['region_attributes']['bridge'] for r in a ['regions'].values()]
                polygons = labels + polygons
                # print("this is dict")
            else:
                print(a['regions'])
                polygons = [r['shape_attributes'] for r in a['regions']]
                print("polygons: ", polygons)
                objects = [s['region_attributes']['bridge'] for s in a['regions']]
                # print("objects")
                # print("polygons: ", polygons)
                # print("objects:",objects)
                name_dict = {"cylinder": 1,"rectangular": 2}
...
def train(model):
    ...
    dataset_val.load_deficiency_crop(args.dataset,"train")
